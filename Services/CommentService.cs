...
//namespace FNF_PROJ.Services
//{
//    // Single concrete comment service (no interface)
//    public class CommentService
//    {
...
//        // Create a comment or a reply. Reuses CommentCreateDto (PostId, ParentCommentId, CommentText, Attachments).
...
//            // If parent specified, validate it belongs to same post
...
//        // Edit: we REUSE CommentCreateDto for payload to avoid adding another DTO.
//        // Only CommentText is used for editing.
...
//            // only author can edit; you can extend to admins/managers if needed
...
//        // Delete comment and all descendants (recursive). Removes attachments & votes for those comments.
...
//            // permission: allow comment author or post author (adjust as needed)
//            if (root.UserId != userId && post.UserId != userId)
//                throw new UnauthorizedAccessException();

//            // gather all descendant ids (DFS)
...
//        // Returns nested comment tree (top-level comments with Replies populated)
//        public async Task<List<CommentResponseDto>> GetForPostAsync(int postId)
//        {
